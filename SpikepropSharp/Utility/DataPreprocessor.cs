namespace SpikepropSharp.Utility
{
	...
	{
		public static double[] Denoise(double[] ecgSignal)
		{
			// Remove power line noise
			ecgSignal = ButterworthLowPass(ecgSignal, 0.001, 50);
		...
		public static Dictionary<double, bool> ApplySodSampling(double[] ecgSignal, double threshold)
		{
		...
		/// <returns></returns>
		public static T[] Shuffle<T>(Random rnd, T[] array)
		{
			int n = array.Length;
			while (n > 1)
			{
		...
		/// <summary>
		/// Fourth order, zero-phase shift, low-pass Butterworth
		...
		/// <returns></returns>
		private static double[] ButterworthLowPass(double[] indata, double deltaTimeinsec, double CutOff)
		{
